...
public class ShoppingMallTabAdapter extends BaseQuickAdapter<HomeTabInfo, BaseViewHolder> {

    private List<HomeTabInfo> list;

    public ShoppingMallTabAdapter(List<HomeTabInfo> list) {
        super(R.layout.item_shoppingmall_tab, list);
        this.list = list;
    }
