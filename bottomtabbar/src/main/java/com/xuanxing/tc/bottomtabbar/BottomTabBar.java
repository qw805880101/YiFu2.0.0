package com.xuanxing.tc.bottomtabbar;
...
public class BottomTabBar extends LinearLayout {
    ...
    private View getTabItemView(String name, Drawable drawableSelect, Drawable drawableUnSelect) {
        ...
        if (name.equals("购物车")) {
            tvNum = (TextView) view.findViewById(R.id.txt_comment_num);
            RelativeLayout.LayoutParams tvParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, context.getResources().getDimensionPixelSize(R.dimen.middle_15));
            tvParams.setMargins(context.getResources().getDimensionPixelSize(R.dimen.middle_35), context.getResources().getDimensionPixelSize(R.dimen.middle_5), context.getResources().getDimensionPixelSize(R.dimen.middle_10)
                    , 0);
            tvParams.addRule(RelativeLayout.RIGHT_OF, iv.getId());
            tvNum.setLayoutParams(tvParams);
...
//    }
    ...
    public BottomTabBar changeFragment(Fragment fragment) {
        mTabHost.changeFragment(fragment);
        return this;
    }
